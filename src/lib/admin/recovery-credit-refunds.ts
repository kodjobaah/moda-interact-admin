...
export async function getRecoveryCreditRefundDetail(id: string): Promise<RecoveryCreditRefundDetail | null> {
  ...
  return {
    ...
    purchase: {
      ...
      providerUsageQuantityBeforeSnapshot: row.purchase.providerUsageQuantityBeforeSnapshot,
      ...
      providerUsageQuantityAfterSnapshot: row.purchase.providerUsageQuantityAfterSnapshot,
